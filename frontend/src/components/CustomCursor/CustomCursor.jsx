  ...
  useEffect(() => {
    ...
    const onMouseOver = (event) => {
      ...
      const isClickable =
        Boolean(
          element.closest(
            "button, a, [role='button'], .clickable, label, input[type='submit'], input[type='button'], input[type='checkbox'], input[type='radio']"
          )
    ...
    return () => {
      ...
      try { document.documentElement.classList.remove("custom-cursor-enabled"); } catch {}
      if (frameRef.current) {
